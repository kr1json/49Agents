...
import { initHudDeps, createHudContainer, createHud, createAgentsHud, createChatHud, pollHud, restartHudPolling, renderHud, applyNoHudMode, applyTerminalTheme, toggleHudHidden, updateHudDotColor, showGuestRegisterModal, initGuestNudge } from './modules/hud.js';
import { initSettingsDeps, showSettingsModal, savePrefsToCloud, setCanvasBackground, setNightMode, getAllPrefs } from './modules/settings.js';
...
(function() {
  ...
  // HUD state — imported from modules/hud.js
  ...
  // HUD functions — imported from modules/hud.js




  // Initialize
  // Guest mode — imported from modules/hud.js
    ...
    initHudDeps({
      cloudFetch, agentRequest, savePrefsToCloud,
      addQuickViewOverlay,
      getState: () => state,
      getAgents: () => agents,
      getActiveAgentId: () => activeAgentId,
      getAgentUpdates: () => agentUpdates,
      getTerminals: () => terminals,
      getClaudeTerminalIds: () => claudeTerminalIds,
    ...
    initSettingsDeps({
      ...
      setNotificationSoundEnabled: (v) => { notificationSoundEnabled = v; _setSoundEnabled(v); },
      getAutoRemoveDoneNotifs: () => autoRemoveDoneNotifs,
      setAutoRemoveDoneNotifs: (v) => { autoRemoveDoneNotifs = v; },
      getSnoozeDurationMs: () => snoozeDurationMs,
      setSnoozeDurationMs: (v) => { snoozeDurationMs = v; },
      getCurrentTerminalFont: () => currentTerminalFont,
      setCurrentTerminalFont: (v) => { currentTerminalFont = v; },
      ...
      getCurrentCanvasBg: () => currentCanvasBg,
      setCurrentCanvasBg: (v) => { currentCanvasBg = v; },
    });
  ...
  // === Settings Modal ===
  // Settings — imported from modules/settings.js
